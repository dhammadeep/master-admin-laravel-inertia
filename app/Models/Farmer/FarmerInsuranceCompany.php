...
class FarmerInsuranceCompany extends Model
{
     use HasFactory;
     ...
     * @var string
     */
    protected $table = 'farmer_insurance_company';
    ...
    protected static $tableFields = [
       ...
       [
        ...
        [
            ...
            'options' => [],
            'source' => "/farmer/insurance-type/list",
            'mount' => true
        ],
       [
            'name' => 'Status',
    ...
    /**
     * Get the FarmerInsuranceType associated with the FarmerInsuranceCompany.
     *
     * @return object
     */
    public function farmerInsuranceType()
    {
        return $this->belongsTo(
            related: FarmerInsuranceType::class,
