...
namespace App\Services\Zonal\PhenophaseDuration;

use Exception;
use App\Http\Requests\Zonal\PhenophaseDuration\PhenophaseDurationRequest;
use App\Repositories\Zonal\PhenophaseDuration\PhenophaseDurationRepository;
use Illuminate\Database\Eloquent\ModelNotFoundException;
use App\Http\Resources\Zonal\PhenophaseDuration\Lists\PhenophaseDurationListResource;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Resources\Zonal\PhenophaseDuration\Table\PhenophaseDurationTableCollection;
...
class PhenophaseDurationService
{
     ...
     * @return void
     */
    public function __construct(PhenophaseDurationRepository $repository)
    {
    ...
    public function getAllPaginatedTableData(String $on = null, String $search = null)
    {
        ...
        try {
           return new PhenophaseDurationTableCollection($this->repository->find($on, $search, $rowsPerPage));
        } catch (Exception $e) {
            throw $e;
        }
    }
    ...
    public function findPhenophaseDurationById(int $id)
    {
        try {
            ...
            return collect(new PhenophaseDurationListResource($this->repository->findById($id)));
        } catch (NotFoundHttpException $e) {
            throw $e;
        } catch (Exception $e) {
            throw $e;
