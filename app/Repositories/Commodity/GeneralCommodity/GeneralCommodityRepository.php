...
class GeneralCommodityRepository implements GeneralCommodityRepoInterface
{
    ...
    {
        try {
        return GeneralCommodity::select('ID','Name')->findOrFail($id);
    ...
    try {
        ...
        $generalCommodity = GeneralCommodity::find($id);
        $generalCommodity->Name = $request->Name;
        $generalCommodity->save();
        return $generalCommodity;
         } catch (Exception $e) {
            throw $e;
        }
    }
