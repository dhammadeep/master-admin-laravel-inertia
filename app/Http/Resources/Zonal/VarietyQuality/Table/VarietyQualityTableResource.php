...
class VarietyQualityTableResource extends JsonResource
{
     /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'CurrentQualityBandName' => $this->CurrentQualityBand->Name ?? '',
            'EstimatedQualityBandName' => $this->EstimatedQualityBand->Name ?? '',
            'AllowableVarianceInQualityBandName' => $this->AllowableVarianceInQualityBand->Name ?? '',
