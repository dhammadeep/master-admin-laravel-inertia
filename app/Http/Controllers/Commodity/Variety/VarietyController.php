...
class VarietyController extends Controller
{
     ...
     * @return Void
     */
    public function __construct(VarietyService $service, Variety $model)
    {
    ...
    {
        return Inertia::render(
            component: 'Frontend/CreateVariety',
            props: [
                'type' => 'Add',
                'title' => 'Add Varieties',
                'url' => $this->baseUrl,
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:agri_variety|distinct',
                'CommodityID\.Commodity\.Name' => 'required|exists:agri_commodity,Name',
                'HsCodeID\.HSNCode\.HSCode' => 'required|exists:agri_hs_code,HSCode',
                'DomesticRestrictions' => 'required',
                'InternationalRestrictions' => 'required',
                'VarietyCode' => 'required',
            ];
