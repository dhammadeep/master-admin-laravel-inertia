...
namespace App\Http\Controllers\Zonal\PlantHealthIndex;
...
use App\Services\Zonal\PlantHealthIndex\PlantHealthIndexService;
use App\Http\Requests\Zonal\PlantHealthIndex\PlantHealthIndexRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class PlantHealthIndexController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/zonal/plant-health-index";

    /**
     * Injects PlantHealthIndex Service dependency through the constructor
     *
     * @param PlantHealthIndexService $service
     *
     * @return Void
     */
    public function __construct(PlantHealthIndexService $service)
    {
     ...
     *
     *@link http://zonal/plant-health-index
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new PlantHealthIndex
     *
     *@link http://zonal/plant-health-index/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/plant-health-index/store
     *
     *@method POST
     *
     ...
     */
    public function store(PlantHealthIndexRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update PlantHealthIndex
     *
     *@link http://zonal/plant-health-index/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findPlantHealthIndexById($id);
     ...
     *
     *@link http://zonal/plant-health-index/update/id
     *
     *@method PATCH/PUT
     *
     * @param PlantHealthIndexRequest  $request The request object
