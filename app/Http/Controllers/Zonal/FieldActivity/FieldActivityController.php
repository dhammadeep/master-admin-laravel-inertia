...
namespace App\Http\Controllers\Zonal\FieldActivity;
...
use App\Services\Zonal\FieldActivity\FieldActivityService;
...
class FieldActivityController extends Controller
{
    ...
    */
    private string $baseUrl = "/zonal/field-activity";

    /**
     * Injects FieldActivity Service dependency through the constructor
     *
     * @param FieldActivityService $service
     *
     * @return Void
     */
    public function __construct(FieldActivityService $service)
    {
     ...
     *
     *@link http://zonal/field-activity
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FieldActivity
     *
     *@link http://zonal/field-activity/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/field-activity/store
     *
     *@method POST
     *
     ...
     */
    public function store(FieldActivityRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FieldActivity
     *
     *@link http://zonal/field-activity/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFieldActivityById($id);
     ...
     *
     *@link http://zonal/field-activity/update/id
     *
     *@method PATCH/PUT
     *
     * @param FieldActivityRequest  $request The request object
