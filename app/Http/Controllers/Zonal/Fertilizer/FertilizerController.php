...
namespace App\Http\Controllers\Zonal\Fertilizer;
...
use App\Services\Zonal\Fertilizer\FertilizerService;
...
class FertilizerController extends Controller
{
    ...
    */
    private string $baseUrl = "/zonal/fertilizer";


    /**
     * Injects Fertilizer Service dependency through the constructor
     *
     * @param FertilizerService $service
     *
     * @return Void
     */
    public function __construct(FertilizerService $service, Fertilizer $model)
    {
    ...
    /**
     * Displays a form to add new Fertilizer
     *
     *@link http://\Zonal/fertilizer/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://\Zonal/fertilizer/store
     *
     *@method POST
     *
    ...
    public function store(FertilizerRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Fertilizer
     *
     *@link http://\Zonal/fertilizer/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFertilizerById($id);
     ...
     *
     *@link http://\Zonal/fertilizer/update/id
     *
     *@method PATCH/PUT
     *
     * @param FertilizerRequest  $request The request object
    ...
    public function export()
    {
        ...
        try {
            ...
            return Excel::download(new CustomExport($isSample = true, Fertilizer::class), 'examples.xlsx');
        } catch (AuthenticationException $e) {
            $code = "HTTP_AUTHENTICATION_ERROR";
        } catch (NotFoundHttpException $e) {
            $code = "HTTP_REQUEST_FAILURE";
