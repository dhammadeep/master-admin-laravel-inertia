...
namespace App\Http\Controllers\Zonal\StressDuration;
...
use App\Services\Zonal\StressDuration\StressDurationService;
use App\Http\Requests\Zonal\StressDuration\StressDurationRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class StressDurationController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/zonal/stress-duration";

    /**
     * Injects StressDuration Service dependency through the constructor
     *
     * @param StressDurationService $service
     *
     * @return Void
     */
    public function __construct(StressDurationService $service)
    {
     ...
     *
     *@link http://zonal/stress-duration
     *
     *@method GET
     *
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render(
            ...
            props: [
                'type' => 'List',
                'title' => "All Zonal Stress Duration",
    ...
    /**
     * Displays a form to add new StressDuration
     *
     *@link http://zonal/stress-duration/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/stress-duration/store
     *
     *@method POST
     *
     ...
     */
    public function store(StressDurationRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update StressDuration
     *
     *@link http://zonal/stress-duration/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findStressDurationById($id);
     ...
     *
     *@link http://zonal/stress-duration/update/id
     *
     *@method PATCH/PUT
     *
     * @param StressDurationRequest  $request The request object
