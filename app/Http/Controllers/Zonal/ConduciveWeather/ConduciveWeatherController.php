...
namespace App\Http\Controllers\Zonal\ConduciveWeather;
...
use App\Services\Zonal\ConduciveWeather\ConduciveWeatherService;
use App\Http\Requests\Zonal\ConduciveWeather\ConduciveWeatherRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class ConduciveWeatherController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/zonal/conducive-weather";

    /**
     * Injects ConduciveWeather Service dependency through the constructor
     *
     * @param ConduciveWeatherService $service
     *
     * @return Void
     */
    public function __construct(ConduciveWeatherService $service)
    {
     ...
     *
     *@link http://zonal/conducive-weather
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new ConduciveWeather
     *
     *@link http://zonal/conducive-weather/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/conducive-weather/store
     *
     *@method POST
     *
     ...
     */
    public function store(ConduciveWeatherRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update ConduciveWeather
     *
     *@link http://zonal/conducive-weather/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findConduciveWeatherById($id);
     ...
     *
     *@link http://zonal/conducive-weather/update/id
     *
     *@method PATCH/PUT
     *
     * @param ConduciveWeatherRequest  $request The request object
