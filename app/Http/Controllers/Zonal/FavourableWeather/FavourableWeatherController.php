...
namespace App\Http\Controllers\Zonal\FavourableWeather;
...
use App\Services\Zonal\FavourableWeather\FavourableWeatherService;
use App\Http\Requests\Zonal\FavourableWeather\FavourableWeatherRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class FavourableWeatherController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/zonal/favourable-weather";

    /**
     * Injects FavourableWeather Service dependency through the constructor
     *
     * @param FavourableWeatherService $service
     *
     * @return Void
     */
    public function __construct(FavourableWeatherService $service)
    {
     ...
     *
     *@link http://zonal/favourable-weather
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FavourableWeather
     *
     *@link http://zonal/favourable-weather/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/favourable-weather/store
     *
     *@method POST
     *
     ...
     */
    public function store(FavourableWeatherRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FavourableWeather
     *
     *@link http://zonal/favourable-weather/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFavourableWeatherById($id);
     ...
     *
     *@link http://zonal/favourable-weather/update/id
     *
     *@method PATCH/PUT
     *
     * @param FavourableWeatherRequest  $request The request object
