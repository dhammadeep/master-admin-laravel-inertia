...
namespace App\Http\Controllers\Zonal\VarietyZonal;
...
use App\Services\Zonal\VarietyZonal\VarietyZonalService;
use App\Http\Requests\Zonal\VarietyZonal\VarietyZonalRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class VarietyZonalController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/zonal/variety-zonal";

    /**
     * Injects VarietyZonal Service dependency through the constructor
     *
     * @param VarietyZonalService $service
     *
     * @return Void
     */
    public function __construct(VarietyZonalService $service)
    {
    ...
    {
        return $this->service->getAllRecords("ZonalCommodityID", $id);
    }


    /**
     * Displays a form to add new VarietyZonal
     *
     *@link http://zonal/variety-zonal/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/variety-zonal/store
     *
     *@method POST
     *
     ...
     */
    public function store(VarietyZonalRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update VarietyZonal
     *
     *@link http://zonal/variety-zonal/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findVarietyZonalById($id);
     ...
     *
     *@link http://zonal/variety-zonal/update/id
     *
     *@method PATCH/PUT
     *
     * @param VarietyZonalRequest  $request The request object
