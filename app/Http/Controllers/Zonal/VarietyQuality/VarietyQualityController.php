...
namespace App\Http\Controllers\Zonal\VarietyQuality;
...
use App\Services\Zonal\VarietyQuality\VarietyQualityService;
use App\Http\Requests\Zonal\VarietyQuality\VarietyQualityRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class VarietyQualityController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/zonal/variety-quality";

    /**
     * Injects VarietyQuality Service dependency through the constructor
     *
     * @param VarietyQualityService $service
     *
     * @return Void
     */
    public function __construct(VarietyQualityService $service)
    {
     ...
     *
     *@link http://zonal/variety-quality
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new VarietyQuality
     *
     *@link http://zonal/variety-quality/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://zonal/variety-quality/store
     *
     *@method POST
     *
     ...
     */
    public function store(VarietyQualityRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update VarietyQuality
     *
     *@link http://zonal/variety-quality/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findVarietyQualityById($id);
     ...
     *
     *@link http://zonal/variety-quality/update/id
     *
     *@method PATCH/PUT
     *
     * @param VarietyQualityRequest  $request The request object
