...
namespace App\Http\Controllers\Stress\CommodityStressStage;
...
use App\Services\Stress\CommodityStressStage\CommodityStressStageService;
use App\Http\Requests\Stress\CommodityStressStage\CommodityStressStageRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class CommodityStressStageController extends Controller
{
    protected $service;
     ...
     */
    private string $baseUrl = "/stress/commodity-stress-stage";

    /**
     * Injects CommodityStressStage Service dependency through the constructor
     *
     * @param CommodityStressStageService $service
     *
     * @return Void
     */
    public function __construct(CommodityStressStageService $service)
    {
     ...
     *
     *@link http://stress/commodity-stress-stage
     *
     *@method GET
     *
    ...
    public function index(Request $request): Response
    {
        ...
        try {
            return Inertia::render(
                ...
                props: [
                    'type' => 'List',
                    'title' => "All Commodity Stress Stage",
    ...
    {
        return $this->service->getAllRecords("StartPhenophaseID", $id);
    }

    /**
     * Displays a form to add new CommodityStressStage
     *
     *@link http://stress/commodity-stress-stage/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://stress/commodity-stress-stage/store
     *
     *@method POST
     *
     ...
     */
    public function store(CommodityStressStageRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
    ...
    /**
     * Displays a form with values to update CommodityStressStage
     *
     *@link http://stress/commodity-stress-stage/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findCommodityStressStageById($id);
     ...
     *
     *@link http://stress/commodity-stress-stage/update/id
     *
     *@method PATCH/PUT
     *
     * @param CommodityStressStageRequest  $request The request object
