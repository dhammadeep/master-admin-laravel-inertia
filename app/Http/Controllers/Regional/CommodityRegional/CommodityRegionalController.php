...
namespace App\Http\Controllers\Regional\CommodityRegional;
...
use App\Services\Regional\CommodityRegional\CommodityRegionalService;
use App\Http\Requests\Regional\CommodityRegional\CommodityRegionalRequest;

class CommodityRegionalController extends Controller
{
    ...
    */
    private string $baseUrl = "/regional/commodity-regional";

    /**
     * Injects CommodityRegional Service dependency through the constructor
     *
     * @param CommodityRegionalService $service
     *
     * @return Void
     */
    public function __construct(CommodityRegionalService $service,CommodityRegional $model)
    {
     ...
     *
     *@link http://regional/commodity-regional
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new CommodityRegional
     *
     *@link http://regional/commodity-regional/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://regional/commodity-regional/store
     *
     *@method POST
     *
     ...
     */
    public function store(CommodityRegionalRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update CommodityRegional
     *
     *@link http://regional/commodity-regional/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findCommodityRegionalById($id);
     ...
     *
     *@link http://regional/commodity-regional/update/id
     *
     *@method PATCH/PUT
     *
     * @param CommodityRegionalRequest  $request The request object
