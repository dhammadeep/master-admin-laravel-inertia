...
namespace App\Http\Controllers\Farmer\FarmerLoanPurpose;
...
use App\Services\Farmer\FarmerLoanPurpose\FarmerLoanPurposeService;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Farmer\FarmerLoanPurpose\FarmerLoanPurposeRequest;

class FarmerLoanPurposeController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/loan-purpose";

    /**
     * Injects FarmerLoanPurpose Service dependency through the constructor
     *
     * @param FarmerLoanPurposeService $service
     *
     * @return Void
     */
    public function __construct(FarmerLoanPurposeService $service, FarmerLoanPurpose $model)
    {
     ...
     *
     *@link http://farmer/farmer-loan-purpose
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerLoanPurpose
     *
     *@link http://farmer/farmer-loan-purpose/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-loan-purpose/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerLoanPurposeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerLoanPurpose
     *
     *@link http://farmer/farmer-loan-purpose/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerLoanPurposeById($id);
     ...
     *
     *@link http://farmer/farmer-loan-purpose/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerLoanPurposeRequest  $request The request object
