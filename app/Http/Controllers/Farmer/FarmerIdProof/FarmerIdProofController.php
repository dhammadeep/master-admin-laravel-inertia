...
namespace App\Http\Controllers\Farmer\FarmerIdProof;
...
use App\Services\Farmer\FarmerIdProof\FarmerIdProofService;
use App\Http\Requests\Farmer\FarmerIdProof\FarmerIdProofRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class FarmerIdProofController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/id-proof";

    /**
     * Injects FarmerIdProof Service dependency through the constructor
     *
     * @param FarmerIdProofService $service
     *
     * @return Void
     */
    public function __construct(FarmerIdProofService $service, FarmerIdProof $model)
    {
     ...
     *
     *@link http://farmer/farmer-id-proof
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerIdProof
     *
     *@link http://farmer/farmer-id-proof/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-id-proof/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerIdProofRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerIdProof
     *
     *@link http://farmer/farmer-id-proof/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerIdProofById($id);
     ...
     *
     *@link http://farmer/farmer-id-proof/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerIdProofRequest  $request The request object
