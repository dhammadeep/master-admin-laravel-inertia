...
namespace App\Http\Controllers\Farmer\FarmerProxyRelationType;
...
use App\Services\Farmer\FarmerProxyRelationType\FarmerProxyRelationTypeService;
use App\Http\Requests\Farmer\FarmerProxyRelationType\FarmerProxyRelationTypeRequest;

class FarmerProxyRelationTypeController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/proxy-relation-type";

    /**
     * Injects FarmerProxyRelationType Service dependency through the constructor
     *
     * @param FarmerProxyRelationTypeService $service
     *
     * @return Void
     */
    public function __construct(FarmerProxyRelationTypeService $service, FarmerProxyRelationType $model)
    {
     ...
     *
     *@link http://farmer/farmer-proxy-relation-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerProxyRelationType
     *
     *@link http://farmer/farmer-proxy-relation-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-proxy-relation-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerProxyRelationTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerProxyRelationType
     *
     *@link http://farmer/farmer-proxy-relation-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerProxyRelationTypeById($id);
     ...
     *
     *@link http://farmer/farmer-proxy-relation-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerProxyRelationTypeRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:farmer_mobile_type'
            ];
