...
namespace App\Http\Controllers\Farmer\FarmerIncomeSource;
...
use App\Services\Farmer\FarmerIncomeSource\FarmerIncomeSourceService;
use App\Http\Requests\Farmer\FarmerIncomeSource\FarmerIncomeSourceRequest;

class FarmerIncomeSourceController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/income-source";

    /**
     * Injects FarmerIncomeSource Service dependency through the constructor
     *
     * @param FarmerIncomeSourceService $service
     *
     * @return Void
     */
    public function __construct(FarmerIncomeSourceService $service, FarmerIncomeSource $model)
    {
     ...
     *
     *@link http://farmer/farmer-income-source
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerIncomeSource
     *
     *@link http://farmer/farmer-income-source/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-income-source/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerIncomeSourceRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerIncomeSource
     *
     *@link http://farmer/farmer-income-source/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerIncomeSourceById($id);
     ...
     *
     *@link http://farmer/farmer-income-source/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerIncomeSourceRequest  $request The request object
