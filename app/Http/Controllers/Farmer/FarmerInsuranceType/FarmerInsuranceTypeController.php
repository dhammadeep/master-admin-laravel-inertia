...
namespace App\Http\Controllers\Farmer\FarmerInsuranceType;
...
use App\Services\Farmer\FarmerInsuranceType\FarmerInsuranceTypeService;
use App\Http\Requests\Farmer\FarmerInsuranceType\FarmerInsuranceTypeRequest;

class FarmerInsuranceTypeController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/insurance-type";

    /**
     * Injects FarmerInsuranceType Service dependency through the constructor
     *
     * @param FarmerInsuranceTypeService $service
     *
     * @return Void
     */
    public function __construct(FarmerInsuranceTypeService $service, FarmerInsuranceType $model)
    {
     ...
     *
     *@link http://farmer/farmer-insurance-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerInsuranceType
     *
     *@link http://farmer/farmer-insurance-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-insurance-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerInsuranceTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerInsuranceType
     *
     *@link http://farmer/farmer-insurance-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerInsuranceTypeById($id);
     ...
     *
     *@link http://farmer/farmer-insurance-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerInsuranceTypeRequest  $request The request object
