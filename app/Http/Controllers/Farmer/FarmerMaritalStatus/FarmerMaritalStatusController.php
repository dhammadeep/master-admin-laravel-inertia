...
namespace App\Http\Controllers\Farmer\FarmerMaritalStatus;
...
use App\Services\Farmer\FarmerMaritalStatus\FarmerMaritalStatusService;
use App\Http\Requests\Farmer\FarmerMaritalStatus\FarmerMaritalStatusRequest;

class FarmerMaritalStatusController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/marital-status";

    /**
     * Injects FarmerMaritalStatus Service dependency through the constructor
     *
     * @param FarmerMaritalStatusService $service
     *
     * @return Void
     */
    public function __construct(FarmerMaritalStatusService $service, FarmerMaritalStatus $model)
    {
     ...
     *
     *@link http://farmer/farmer-marital-status
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerMaritalStatus
     *
     *@link http://farmer/farmer-marital-status/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-marital-status/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerMaritalStatusRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerMaritalStatus
     *
     *@link http://farmer/farmer-marital-status/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerMaritalStatusById($id);
     ...
     *
     *@link http://farmer/farmer-marital-status/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerMaritalStatusRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:farmer_loan_source'
            ];
