...
namespace App\Http\Controllers\Farmer\FarmerMobileType;
...
use App\Services\Farmer\FarmerMobileType\FarmerMobileTypeService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Farmer\FarmerMobileType\FarmerMobileTypeRequest;

class FarmerMobileTypeController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/mobile-type";

    /**
     * Injects FarmerMobileType Service dependency through the constructor
     *
     * @param FarmerMobileTypeService $service
     *
     * @return Void
     */
    public function __construct(FarmerMobileTypeService $service, FarmerMobileType $model)
    {
     ...
     *
     *@link http://farmer/farmer-mobile-type
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerMobileType
     *
     *@link http://farmer/farmer-mobile-type/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-mobile-type/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerMobileTypeRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerMobileType
     *
     *@link http://farmer/farmer-mobile-type/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerMobileTypeById($id);
     ...
     *
     *@link http://farmer/farmer-mobile-type/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerMobileTypeRequest  $request The request object
