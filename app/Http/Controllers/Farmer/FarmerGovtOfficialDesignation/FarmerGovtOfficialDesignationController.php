...
namespace App\Http\Controllers\Farmer\FarmerGovtOfficialDesignation;
...
use App\Services\Farmer\FarmerGovtOfficialDesignation\FarmerGovtOfficialDesignationService;
use App\Http\Requests\Farmer\FarmerGovtOfficialDesignation\FarmerGovtOfficialDesignationRequest;

class FarmerGovtOfficialDesignationController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/govt-official-designation";

    /**
     * Injects FarmerGovtOfficialDesignation Service dependency through the constructor
     *
     * @param FarmerGovtOfficialDesignationService $service
     *
     * @return Void
     */
    public function __construct(FarmerGovtOfficialDesignationService $service, FarmerGovtOfficialDesignation $model)
    {
     ...
     *
     *@link http://farmer/farmer-govt-official-designation
     *
     *@method GET
     *
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render(
            ...
            props: [
                'type' => 'List',
                'title' => "All Govt Official Designation",
    ...
    /**
     * Displays a form to add new FarmerGovtOfficialDesignation
     *
     *@link http://farmer/farmer-govt-official-designation/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-govt-official-designation/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerGovtOfficialDesignationRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerGovtOfficialDesignation
     *
     *@link http://farmer/farmer-govt-official-designation/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerGovtOfficialDesignationById($id);
     ...
     *
     *@link http://farmer/farmer-govt-official-designation/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerGovtOfficialDesignationRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:farmer_govt_official_designation'
            ];
