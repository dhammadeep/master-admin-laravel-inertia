...
namespace App\Http\Controllers\Farmer\FarmerInsuranceCompany;
...
use App\Services\Farmer\FarmerInsuranceCompany\FarmerInsuranceCompanyService;
use App\Http\Requests\Farmer\FarmerInsuranceCompany\FarmerInsuranceCompanyRequest;

class FarmerInsuranceCompanyController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/insurance-company";

    /**
     * Injects FarmerInsuranceCompany Service dependency through the constructor
     *
     * @param FarmerInsuranceCompanyService $service
     *
     * @return Void
     */
    public function __construct(FarmerInsuranceCompanyService $service, FarmerInsuranceCompany $model)
    {
     ...
     *
     *@link http://farmer/farmer-insurance-company
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerInsuranceCompany
     *
     *@link http://farmer/farmer-insurance-company/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-insurance-company/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerInsuranceCompanyRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerInsuranceCompany
     *
     *@link http://farmer/farmer-insurance-company/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerInsuranceCompanyById($id);
     ...
     *
     *@link http://farmer/farmer-insurance-company/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerInsuranceCompanyRequest  $request The request object
