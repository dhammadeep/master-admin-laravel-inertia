...
namespace App\Http\Controllers\Farmer\FarmerVIPStatus;
...
use App\Services\Farmer\FarmerVIPStatus\FarmerVIPStatusService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Farmer\FarmerVIPStatus\FarmerVIPStatusRequest;

class FarmerVIPStatusController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/vip-status";

    /**
     * Injects FarmerVIPStatus Service dependency through the constructor
     *
     * @param FarmerVIPStatusService $service
     *
     * @return Void
     */
    public function __construct(FarmerVIPStatusService $service, FarmerVIPStatus $model)
    {
     ...
     *
     *@link http://farmer/farmer-v-i-p-status
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerVIPStatus
     *
     *@link http://farmer/farmer-v-i-p-status/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-v-i-p-status/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerVIPStatusRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerVIPStatus
     *
     *@link http://farmer/farmer-v-i-p-status/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerVIPStatusById($id);
     ...
     *
     *@link http://farmer/farmer-v-i-p-status/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerVIPStatusRequest  $request The request object
    ...
    */
    public function import(BulkInsertRequest $bulkInsertRequest)
    {
        ...
        try {
            $validation = [
                'Name' => 'required|unique:farmer_vip_status'
            ];
