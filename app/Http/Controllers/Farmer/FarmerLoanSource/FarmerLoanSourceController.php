...
namespace App\Http\Controllers\Farmer\FarmerLoanSource;
...
use App\Services\Farmer\FarmerLoanSource\FarmerLoanSourceService;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;
use App\Http\Requests\Farmer\FarmerLoanSource\FarmerLoanSourceRequest;

class FarmerLoanSourceController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/loan-source";

    /**
     * Injects FarmerLoanSource Service dependency through the constructor
     *
     * @param FarmerLoanSourceService $service
     *
     * @return Void
     */
    public function __construct(FarmerLoanSourceService $service, FarmerLoanSource $model)
    {
     ...
     *
     *@link http://farmer/farmer-loan-source
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerLoanSource
     *
     *@link http://farmer/farmer-loan-source/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-loan-source/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerLoanSourceRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerLoanSource
     *
     *@link http://farmer/farmer-loan-source/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerLoanSourceById($id);
     ...
     *
     *@link http://farmer/farmer-loan-source/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerLoanSourceRequest  $request The request object
