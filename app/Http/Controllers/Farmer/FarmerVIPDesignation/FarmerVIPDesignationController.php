...
namespace App\Http\Controllers\Farmer\FarmerVIPDesignation;
...
use App\Services\Farmer\FarmerVIPDesignation\FarmerVIPDesignationService;
use App\Http\Requests\Farmer\FarmerVIPDesignation\FarmerVIPDesignationRequest;

class FarmerVIPDesignationController extends Controller
{
    ...
    */
    private string $baseUrl = "/farmer/vip-designation";

    /**
     * Injects FarmerVIPDesignation Service dependency through the constructor
     *
     * @param FarmerVIPDesignationService $service
     *
     * @return Void
     */
    public function __construct(FarmerVIPDesignationService $service, FarmerVIPDesignation $model)
    {
     ...
     *
     *@link http://farmer/farmer-v-i-p-designation
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new FarmerVIPDesignation
     *
     *@link http://farmer/farmer-v-i-p-designation/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://farmer/farmer-v-i-p-designation/store
     *
     *@method POST
     *
     ...
     */
    public function store(FarmerVIPDesignationRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update FarmerVIPDesignation
     *
     *@link http://farmer/farmer-v-i-p-designation/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findFarmerVIPDesignationById($id);
     ...
     *
     *@link http://farmer/farmer-v-i-p-designation/update/id
     *
     *@method PATCH/PUT
     *
     * @param FarmerVIPDesignationRequest  $request The request object
