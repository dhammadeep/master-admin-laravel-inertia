...
namespace App\Http\Controllers\Yields\QuantityLossChart;
...
use App\Services\Yields\QuantityLossChart\QuantityLossChartService;
use App\Http\Requests\Yields\QuantityLossChart\QuantityLossChartRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\HttpFoundation\Exception\BadRequestException;

class QuantityLossChartController extends Controller
{
    protected $service;
    ...
    */
    private string $baseUrl = "/yields/quantity-loss-chart";

    /**
     * Injects QuantityLossChart Service dependency through the constructor
     *
     * @param QuantityLossChartService $service
     *
     * @return Void
     */
    public function __construct(QuantityLossChartService $service)
    {
     ...
     *
     *@link http://yields/quantity-loss-chart
     *
     *@method GET
     *
    ...
    /**
     * Displays a form to add new QuantityLossChart
     *
     *@link http://yields/quantity-loss-chart/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://yields/quantity-loss-chart/store
     *
     *@method POST
     *
     ...
     */
    public function store(QuantityLossChartRequest $request)
    {
        $data = null;
        $code = "SUCCESS";
        try {
     ...
     /**
     * Displays a form with values to update QuantityLossChart
     *
     *@link http://yields/quantity-loss-chart/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findQuantityLossChartById($id);
     ...
     *
     *@link http://yields/quantity-loss-chart/update/id
     *
     *@method PATCH/PUT
     *
     * @param QuantityLossChartRequest  $request The request object
