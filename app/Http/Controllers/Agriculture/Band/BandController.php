...
namespace App\Http\Controllers\Agriculture\Band;
...
use App\Services\Agriculture\Band\BandService;
...
class BandController extends Controller
{
    ...
    */
    private string $baseUrl = "/agriculture/band";

    /**
     * Injects Band Service dependency through the constructor
     *
     * @param BandService $service
     *
     * @return Void
     */
    public function __construct(BandService $service)
    {
    ...
    /**
     * Displays a form to add new Band
     *
     *@link http://agriculture/band/create/
     *
     *@method GET
     *
     * @return Response
     ...
     *
     *@link http://agriculture/band/store
     *
     *@method POST
     *
    ...
    public function store(BandRequest $request)
    {
     ...
     /**
     * Displays a form with values to update Band
     *
     *@link http://agriculture/band/edit/id
     *
     *@method GET
     *
     * @return Response
    ...
    public function edit(int $id): Response
    {
        ...
        $code = "SUCCESS";
        try {
            $data = $this->service->findBandById($id);
     ...
     *
     *@link http://agriculture/band/update/id
     *
     *@method PATCH/PUT
     *
     * @param BandRequest  $request The request object
